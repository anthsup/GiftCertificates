...
public class GiftCertificateTagRepositoryImpl implements GiftCertificateTagRepository {
    ...
    private static final String GET_TAGS_IDS_BY_CERTIFICATE_ID = "SELECT * FROM  certificate_tag WHERE tag_id = ?";
    ...
    @Override
    public List<Long> getCertificateTags(long certificateId) {
        return jdbcOperations.query(GET_TAGS_IDS_BY_CERTIFICATE_ID,
                (resultSet, i) -> resultSet.getLong("certificate_id"), certificateId);
    }
}
