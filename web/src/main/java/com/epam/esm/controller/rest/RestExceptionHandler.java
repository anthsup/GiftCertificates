...
public class RestExceptionHandler {
    ...
    public ErrorInfo handleHttpMediaTypeNotSupportedException() {
    ...
    public ErrorInfo handleHttpMediaTypeNotAcceptableException() {
    ...
    public ErrorInfo handleHttpRequestMethodNotSupportedException() {
